...
char filename[] = "C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_28\\dict0.txt";
void main() {
	...
	LoadWords(filename);
	// сообщаем какие данные обрабатываютс€
	printf("Experiment with array lenth = %d, file = %s\n", n, filename);

	// t1 - сколько прошло времени от старта программы до окончани€ загрузки 	массива
	int t1 = clock();
	...
	// t2 - сколько прошло времени от старта программы до окончани€ сортировки
	long t2 = clock();
