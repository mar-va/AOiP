...
void load() {
	FILE* fin = fopen("C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_19\\in1.txt", "rt");
	if (fin == NULL) {
		printf("¬ходной файл не найден\n");
		return;
	}
...
void SaveResult() {
	...
	FILE* fout = fopen("C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_19\\out1.txt", "wt");
	if (fout == NULL) {
		printf("¬ходной файл не найден\n");
		return;
	}
...
void load3() {
	FILE* fin = fopen("C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_19\\in3.txt", "rt");
	if (fin == NULL) {
		printf("¬ходной файл не найден\n");
		return;
	}
...
void SaveResult3() {
	...
	FILE* fout = fopen("C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_19\\out3.txt", "wt");
	if (fout == NULL) {
		printf("¬ходной файл не найден\n");
		return;
	}
...
void load4() {
	FILE* fin = fopen("C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_19\\in4.txt", "rt");
	if (fin == NULL) {
		printf("¬ходной файл не найден\n");
		return;
	}
...
void SaveResult4() {
	...
	FILE* fout = fopen("C:\\Users\\Vika\\Desktop\\”нивер\\OAiP\\Lab_19\\out4.txt", "wt");
	if (fout == NULL) {
		printf("¬ходной файл не найден\n");
		return;
	}
